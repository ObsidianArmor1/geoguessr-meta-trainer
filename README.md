...
- V-board base cells use canonical heading-aware corpus thumbnails. Shift +
  hover enlarges a cell with native Street View; four-direction mode retains
  the four heading-aware thumbnail views.
